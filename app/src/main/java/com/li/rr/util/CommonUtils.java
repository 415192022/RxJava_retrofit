...
public class CommonUtils {
    ...
    public static void showDialog(Context context){
        ...
        materialDialog.title("xxxxxx");
        materialDialog.backgroundColor(Color.parseColor("#00000000"));
        materialDialog.show();
    }

    public static void showPopupMenu(Context context,View view,PopupMenu.OnMenuItemClickListener l){
